...
- [ ] [1] PR-A: non-root pg-client (USER 1000) + --db-url DSN + --db-schema (Containerfile.pgclient, migrate_oneshot, container_runtime, deployment_adapter, tests) (P1) @systems-programmer — 2026-07-22
